...
Format with clear headings using markdown (## for sections, ### for sub-sections).`
      ...
      const apiBase1 = (import.meta.env.VITE_API_URL || 'http://localhost:5000/api') + '/analysis/ai-report'
  ...
  const askQuestion = async () => {
    ...
    try {
      ...
      const apiBase2 = (import.meta.env.VITE_API_URL || 'http://localhost:5000/api') + '/analysis/ai-report'

        ...
        <div className="table-wrapper">
          <table>
            <thead><tr>
              ...
              <th>Answered</th><th>Section</th><th>Tab</th><th>Split</th><th>Heartbeat</th>
                  ...
                  <tr key={s.id} style={{ background: s.is_flagged ? '#fff5f5' : undefined }}>
                    ...
                    <td>
                      <div style={{ fontSize: 11 }}>
                        {s.current_section === 'aptitude_reasoning' && <span style={{ color: 'var(--color-primary)', fontWeight: 600 }}>🧮 Apt</span>}
                        {s.current_section === 'verbal' && <span style={{ color: 'var(--color-warning)', fontWeight: 600 }}>📝 Ver</span>}
                        {!s.current_section && <span style={{ color: 'var(--color-text-muted)' }}>—</span>}
                        {s.aptitude_submitted_at && <div style={{ color: 'var(--color-success)', fontSize: 10 }}>Apt ✓</div>}
                        {s.verbal_submitted_at && <div style={{ color: 'var(--color-success)', fontSize: 10 }}>Ver ✓</div>}
                      </div>
                    </td>
                    <td>
